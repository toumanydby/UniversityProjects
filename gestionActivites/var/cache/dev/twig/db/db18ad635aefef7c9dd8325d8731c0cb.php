...
class __TwigTemplate_c0e8917347e2d78255e697e5c13c062c extends Template
{
    private $source;
    private $macros = [];
    ...
    <div style=\"display: flex;\">
        <div class=\"card\" style=\"width: 18rem; flex-grow: 1;\"  >
            <div class=\"card-body\">
                <h5 class=\"card-title\">Activities</h5>
                <p class=\"card-text\">Retourne sur la liste des activites</p>
                <a href=\"{{ path('activity_index') }}\" class=\"btn btn-warning stretched-link\">Click Here</a>
            </div>
        </div>
...
{% endblock %}
", "activity/show.html.twig", "/var/www/html/projet/templates/activity/show.html.twig");
    }
}
