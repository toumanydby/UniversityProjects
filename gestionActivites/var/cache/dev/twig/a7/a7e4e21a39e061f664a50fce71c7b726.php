...
/* user/edit.html.twig */
class __TwigTemplate_8028f1caabe4ca852f9f5138045e17a4 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 class=\"mx-5 text-center\">Register to the activities</h1>
...
{% block body %}
    <h1 class=\"mx-5 text-center\">Register to the activities</h1>
    ...
    <div class=\"card\" style=\"width: 18rem; flex-grow: 1;\"  >
        <div class=\"card-body\">
            <h5 class=\"card-title\">Back to the activity list</h5>
            <p class=\"card-text\">Contient toutes les activites</p>
            <a href=\"{{ path('activity_index') }}\" class=\"btn btn-primary stretched-link\">Click Here</a>
        </div>
    </div>

{% endblock %}
", "user/edit.html.twig", "/var/www/html/projectFwCc/templates/user/edit.html.twig");
    }
}
