...
class __TwigTemplate_07900020575602300c2722e26229b401 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"/activity/myActivity\">back to list</a>

    <a href=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("activity_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["activity"]) || array_key_exists("activity", $context) ? $context["activity"] : (function () { throw new RuntimeError('Variable "activity" does not exist.', 27, $this->source); })()), "id", [], "any", false, false, false, 27)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "activity/showMyActivity.html.twig", "/var/www/html/projectFwCc/templates/activity/showMyActivity.html.twig");
    }
}
